...
var UXDB = function(clientConstructor) {
  ...
  this.types = require('uxdb-types');
};

util.inherits(UXDB, EventEmitter);

UXDB.prototype.end = function() {
  var self = this;
...
UXDB.prototype.connect = function(config, callback) {
...
UXDB.prototype.cancel = function(config, client, query) {
  if(client.native) {
...
if(typeof process.env.NODE_PG_FORCE_NATIVE != 'undefined') {
  ...
  module.exports = new UXDB(Client);
