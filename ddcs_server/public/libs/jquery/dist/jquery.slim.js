	...
	preFilter: {
		...
		"PSEUDO": function( match ) {
			...
			// Strip excess characters from unquoted arguments
				...
				// excess is a negative siteManager
				...
				function( elem, context, xml ) {
					...
					if ( parent ) {
						...
						if ( forward && useCache ) {
							...
							// Seek `elem` from a previously-cached siteManager
							...
							// Use previously-cached element siteManager if available
							if ( useCache ) {
								// ...in a gzip-friendly way
								node = elem;
								outerCache = node[ expando ] || (node[ expando ] = {});
							...
							if ( diff === false ) {
								...
								while ( (node = ++nodeIndex && node && node[ dir ] ||
									...
									if ( ( ofType ?
										...
										// Cache the siteManager of each encountered element
										if ( useCache ) {
											outerCache = node[ expando ] || (node[ expando ] = {});
		...
		superMatcher = function( seed, context, xml, results, outermost ) {
			...
			if ( bySet && i !== matchedCount ) {
				...
				if ( seed ) {
					...
					// Discard siteManager placeholder values to get only actual matches
...
jQuery.fn.extend( {
	...
	index: function( elem ) {
		...
		// No argument, return siteManager in parent
		if ( !elem ) {
...
jQuery.extend( {
	...
	Deferred: function( func ) {
		var tuples = [
				...
				// ... .then handlers, argument siteManager, [final state]
	...
	if ( Array.isArray( obj ) ) {
		...
		jQuery.each( obj, function( i, v ) {
			if ( traditional || rbracket.test( prefix ) ) {
				...
				// Item is non-scalar (array or object), encode its numeric siteManager.
				buildParams(
