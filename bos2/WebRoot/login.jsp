...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginFunc">
				<div id="lbNormal" class="loginFuncMobile" style="font-size:20px">员工登录</div>
				<a href="register.jsp" style="position:absolute;top:3px;right:5px;font-size:14px;color:blue">注册</a>
			</div>
			<div class="loginForm">
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<input id="loginform:codeInput" class="loginFormTdIpt" type="text"
								name="volidatecode" title="请输入验证码" />
							<img id="loginform:vCode" src="${pageContext.request.contextPath }/validatecode.jsp"
								onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/validatecode.jsp?'+Math.random();" />
						</div>
						<input type="submit" value="登录" id="submitButton" class="btn btn-login" style="width:102px;height:35px;display:block;margin-top:-35px">
					</div>
				</form>
			</div>
		</div>
